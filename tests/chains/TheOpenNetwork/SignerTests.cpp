...
TEST(TheOpenNetworkSigner, SimpleTransferAllBalanceNonBounceable) {
    auto input = Proto::SigningInput();
    auto& transfer = *input.mutable_simple_transfer();
    auto& walletTransferData = *transfer.mutable_wallet_transfer_data();

    walletTransferData.set_wallet_version(Proto::WALLET_V4_R2);
    walletTransferData.set_dest("UQBm--PFwDv1yCeS-QTJ-L8oiUpqo9IT1BwgVptlSq3ts4DV");
    walletTransferData.set_amount(0);
    walletTransferData.set_sequence_number(8);
    walletTransferData.set_mode(Proto::SendMode::ATTACH_ALL_CONTRACT_BALANCE | Proto::SendMode::IGNORE_ACTION_PHASE_ERRORS);
    walletTransferData.set_expire_at(1681102222);
    walletTransferData.set_bounceable(false);
...
TEST(TheOpenNetworkSigner, SimpleTransferWithASCIIComment) {
    auto input = Proto::SigningInput();
    auto& transfer = *input.mutable_simple_transfer();
    auto& walletTransferData = *transfer.mutable_wallet_transfer_data();

    walletTransferData.set_wallet_version(Proto::WALLET_V4_R2);
    walletTransferData.set_dest("EQBm--PFwDv1yCeS-QTJ-L8oiUpqo9IT1BwgVptlSq3ts90Q");
    walletTransferData.set_amount(10);
    walletTransferData.set_sequence_number(10);
    walletTransferData.set_mode(Proto::SendMode::PAY_FEES_SEPARATELY | Proto::SendMode::IGNORE_ACTION_PHASE_ERRORS);
    walletTransferData.set_expire_at(1681102222);
    walletTransferData.set_bounceable(true);
    transfer.set_comment("test comment");
...
TEST(TheOpenNetworkSigner, SimpleTransferInvalidWalletVersion) {
    auto input = Proto::SigningInput();
    auto& transfer = *input.mutable_simple_transfer();
    auto& walletTransferData = *transfer.mutable_wallet_transfer_data();

    walletTransferData.set_wallet_version(Proto::WALLET_V3_R2);
    walletTransferData.set_dest("EQDYW_1eScJVxtitoBRksvoV9cCYo4uKGWLVNIHB1JqRR3n0");
    walletTransferData.set_amount(10);
    walletTransferData.set_mode(Proto::SendMode::PAY_FEES_SEPARATELY | Proto::SendMode::IGNORE_ACTION_PHASE_ERRORS);
    walletTransferData.set_expire_at(1671135440);
    walletTransferData.set_bounceable(true);
...
TEST(TheOpenNetworkSigner, JettonTransfer) {
    auto input = Proto::SigningInput();
    auto& transfer = *input.mutable_jetton_transfer();
    auto& walletTransferData = *transfer.mutable_wallet_transfer_data();

    walletTransferData.set_wallet_version(Proto::WALLET_V4_R2);
    walletTransferData.set_dest("EQBiaD8PO1NwfbxSkwbcNT9rXDjqhiIvXWymNO-edV0H5lja");
    walletTransferData.set_amount(100 * 1000 * 1000); 
    walletTransferData.set_mode(Proto::SendMode::PAY_FEES_SEPARATELY | Proto::SendMode::IGNORE_ACTION_PHASE_ERRORS);
    walletTransferData.set_expire_at(1787693046);
    walletTransferData.set_bounceable(true);
    transfer.set_response_address("EQBaKIMq5Am2p_rfR1IFTwsNWHxBkOpLTmwUain5Fj4llTXk"); // send unused toncoins back to sender
    transfer.set_to_owner("EQAFwMs5ha8OgZ9M4hQr80z9NkE7rGxUpE1hCFndiY6JnDx8");
    transfer.set_query_id(69);
    transfer.set_forward_amount(1);
    transfer.set_jetton_amount(1000 * 1000 * 1000); // transfer 1 testtwt (decimal precision is 9)
...
TEST(TheOpenNetworkSigner, JettonTransferComment) {
    ...
    walletTransferData.set_dest("EQBiaD8PO1NwfbxSkwbcNT9rXDjqhiIvXWymNO-edV0H5lja");
    walletTransferData.set_amount(100 * 1000 * 1000);
    walletTransferData.set_sequence_number(1);
    walletTransferData.set_mode(Proto::SendMode::PAY_FEES_SEPARATELY | Proto::SendMode::IGNORE_ACTION_PHASE_ERRORS);
    walletTransferData.set_expire_at(1787693046);
    walletTransferData.set_bounceable(true);
    transfer.set_jetton_amount(500 * 1000 * 1000); // transfer 0.5 testtwt (decimal precision is 9)
    transfer.set_to_owner("EQAFwMs5ha8OgZ9M4hQr80z9NkE7rGxUpE1hCFndiY6JnDx8");
    transfer.set_response_address("EQBaKIMq5Am2p_rfR1IFTwsNWHxBkOpLTmwUain5Fj4llTXk"); // send unused toncoins back to sender
    transfer.set_comment("test comment");
    transfer.set_forward_amount(1);
